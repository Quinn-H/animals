...
var GameState = {
  ...
  // show text
    ...
    this.leftArrow.input.pixlPerfectClick = true
    ...
    this.rightArrow.input.pixlPerfectClick = true
  ...
  switchAnimal: function (sprite, event) {
    ...
    this.animalText.visiable = false
...
// initiate the Phaser framework 640px, 360px, use webGL if it avaible
// if not avaible use canvas
